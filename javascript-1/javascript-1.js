...
//CODE HERE
  let phone1 = new Phone ('Motorola', 'G6', 256, 'blue', false);
  
  let phone2 = new Phone ('Apple', 'iPhone10', 300, 'white', false);
  
  let phone3 = new Phone ('Motorola', 'G Power', 256, 'black', false);
